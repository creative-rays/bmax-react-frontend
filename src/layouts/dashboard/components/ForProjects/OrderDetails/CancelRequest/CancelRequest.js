...
function MinHeightTextarea() {
  ...
  return <Textarea aria-label="minimum height" minRows={3} placeholder="Minimum 3 rows" />;
}
    ...
    <React.Fragment>
      ...
      >
        ...
        >
          ...
          >
            <option value={10} width={100}>
              Delivery Address
            </option>
            <option value={20} width={100}>
              Contrete Type
            </option>
            <option value={30} width={100}>
              Vehicle Type
            </option>
          </Select> */}
